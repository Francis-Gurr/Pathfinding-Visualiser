...
mapboxgl.accessToken =
  "pk.eyJ1IjoiZnJhbmNpcy1nIiwiYSI6ImNrbDZyc3U4bjFndG0ycG1uam5sdjYyMzkifQ.5I5Q5hF5IEv9n2f87hGw2g";
...
const Map = ({ startLoc, endLoc }) => {
  ...
  useEffect(() => {
    ...
    // Map bounds
    var bounds = [
      [-1.4866, 53.3718], // [west, south] i.e. [minlong, minlat]
      [-1.4542, 53.3906], // [east, north] i.e. [maxlong, maxlat]
    ];
